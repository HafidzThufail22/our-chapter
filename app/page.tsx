...
export default function Home() {
  return (
    <div className="min-h-screen bg-soft-blue overflow-x-hidden">
      <Navbar />
      ...
      {/* Our Story Section */}
      <section id="story" className="py-20 px-4 bg-gradient-to-b from-soft-blue to-ocean-blue/10">
          ...
          >
            <div className="prose prose-lg max-w-none">
              <p className="text-deep-navy/80 leading-relaxed mb-6">
                In a world full of billions of people, somehow our paths crossed at just the right moment. 
                What started as a simple hello has blossomed into the most beautiful chapter of our lives.
              </p>
              
              <p className="text-deep-navy/80 leading-relaxed mb-6">
                Every day with you feels like a dream I never want to wake up from. You've shown me what 
                it means to truly love and be loved. Through laughter and tears, adventures and quiet moments, 
                we've built something extraordinary together.
              </p>

              <p className="text-deep-navy/80 leading-relaxed">
                This is our story—a tale of two hearts that found their home in each other. And this is 
                just the beginning of our forever.
              </p>
            </div>
            ...
            >
              <Heart className="text-romantic-pink" size={24} fill="currentColor" />
      ...
      <footer className="py-12 px-4 bg-deep-navy text-soft-blue">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-soft-blue/60 text-sm">
            © {new Date().getFullYear()} OurChapter. Every moment, every memory, forever cherished.
          </p>
        </div>
      </footer>
    </div>
